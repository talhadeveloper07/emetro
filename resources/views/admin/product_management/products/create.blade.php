        ...
        <div class="container-xl">
            <div class="row row-deck row-cards">
                ...
                <div class="col-12">
                    ...
                    <form action="{{ route('e_admin.product_management.product.store') }}" method="POST" class="space-y-3" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    ...
                                    {{--<div class="col-12 col-md-4">
                                        ...
                                        <input type="text" name="small_title" class="form-control" value="{{ old('small_title') }}" >
                                    </div>--}}
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <select name="product_type" id="product_type" class="form-select">
                                            ...
                                            <option value="Service" {{ old('product_type') == 'Service' ? 'selected' : '' }}>Services</option>
                                        </select>
                                    </div>
                                    <div class="col-12 col-md-4" id="product_subtype_section">
                                        ...
                                        <select name="product_sub_type" id="product_sub_type" class="form-select" {{ old('product_type') == 'Service' ? 'required' : '' }}>
                                            <option value="">-- Select Subtype --</option>
                                            @php
                                                $subtypes = getProductSubTypes();
                                                $selectedType = old('product_type');
                                                $selectedSubtype = old('product_sub_type');
                                            @endphp
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="row">
                                            ...
                                            <div class="col-auto" style="position: relative;">
                                                <span  id="imagePreview"  data-bs-toggle="modal" data-bs-target="#previewModal" class=" avatar avatar-1 imageProductPreview cursor-pointer" @if(old('image')) style="background-image: url({{ old('image') }})" @else style="display: none;" @endif > </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 col-md-4" >
                                        ...
                                        <select name="status" id="status" class="form-select" >
                                            ...
                                            <option value="Discontinue" {{ old('status') == 'Discontinue' ? 'selected' : '' }}>Discontinue</option>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="additional_information" class="form-control" rows="5">{{ old('additional_information') }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row d-none" id="hw_dimensions_section">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="number" step="0.01" name="dimension_length" id="dimension_length" class="form-control" value="{{ old('dimension_length' ?? '') }}">
                                            </div>

                                            <div class="col-md-3">
                                                <label for="dimension_width">Width</label>
                                                <input type="number" step="0.01" name="dimension_width" id="dimension_width" class="form-control" value="{{ old('dimension_width' ?? '') }}">
                                            </div>

                                            <div class="col-md-3">
                                                <label for="dimension_height">Height</label>
                                                <input type="number" step="0.01" name="dimension_height" id="dimension_height" class="form-control" value="{{ old('dimension_height' ?? '') }}">
                                            </div>
                                            ...
                                            <div class="col-md-3 mt-3">
                                                ...
                                                <select name="weight_unit" id="weight_unit" class="form-control">
                                                    <option value="lb" {{ old('weight_unit' ?? 'lb') === 'lb' ? 'selected' : '' }}>Pounds (LB)</option>
                                            ...
                                            <div class="col-md-3 mt-3">
                                                ...
                                                <input type="number" step="0.01" name="net_weight" id="net_weight" class="form-control" value="{{ old('net_weight' ?? '') }}">
                                            </div>

                                            <div class="col-md-3 mt-3">
                                                <label for="gross_weight">Gross Weight</label>
                                                <input type="number" step="0.01" name="gross_weight" id="gross_weight" class="form-control" value="{{ old('gross_weight'?? '') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <input type="number" step=".01" name="sort_order" class="form-control" value="{{ old('sort_order') }}" required>
                                </div>
                            </div>
                        </div>
                        <!-- Product Price Card -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" step="0.01"
                                                           ...
                                                           class="form-control"
                                                           value="{{ old('product_prices.' . $priceRegion->id . '.price') }}">
                                                </td>
                                                <td>
                                                    <input type="date"
                                                           ...
                                                           class="form-control"
                                                           value="{{ old('product_prices.' . $priceRegion->id . '.availability') }}">
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                        ...
                        <div class="card" id="sw_hw_card" class="{{ !old('product_type') || old('product_type') == 'Service' ? 'd-none' : '' }}">
                            <div class="card-body">
                                <h5 class="card-title fw-bold" id="sw_hw_title">
                                    {{ old('product_type') == 'Software' ? 'SW Subscription' : (old('product_type') == 'Hardware' ? 'HW Warranty' : 'SW Subscription and HW Warranty') }}
                                </h5>
                                <div class="row g-3">
                                    <div class="col-md-12 {{ old('product_type') == 'Software' ? '' : 'd-none' }}" id="sw_subscription_year">
{{--                                        <label for="sw_subscription_per_year_p" class="form-label">SW Subscription, per Year</label>--}}
{{--                                        <input type="text"  name="sw_subscription_per_year_p" id="sw_subscription_per_year_p" class="form-control" value="{{ old('sw_subscription_per_year_p') }}">--}}
                                        <p><b>Note:</b> For software subscription, you must create a dedicated Software Subscription Code and associate it with the corresponding software product.</p>

                                    </div>
                                    {{--<div class="col-md-6 {{ old('product_type') == 'Software' ? '' : 'd-none' }}" id="sw_subscription_month">
                                        <label for="sw_subscription_per_month_p" class="form-label">SW Subscription, per Month</label>
                                        <input type="text"  name="sw_subscription_per_month_p" id="sw_subscription_per_month_p" class="form-control" value="{{ old('sw_subscription_per_month_p') }}">
                                    </div>--}}
                                    <div class="col-md-12 {{ old('product_type') == 'Hardware' ? '' : 'd-none' }}" id="hw_warranty_year">
{{--                                        <label for="hw_warranty_per_year_price" class="form-label">HW Warranty, per Year</label>--}}
{{--                                        <input type="text" name="hw_warranty_per_year_price" id="hw_warranty_per_year_price" class="form-control" value="{{ old('hw_warranty_per_year_price') }}">--}}
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-4">
                                        ...
                                        <select name="assurance_renewal" id="assurance_renewal" class="form-select">
                                            ...
                                            <option value="yes" {{ old('assurance_renewal') == 'yes' ? 'selected' : 'selected' }}>Yes</option>
                                            <option value="no" {{ old('assurance_renewal') == 'no' ? 'selected' : '' }}>No</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="discount_category_id" id="discount_category_id" class="form-select">
                                            ...
                                            @foreach($discounts as $discount)
                                                <option value="{{ $discount->id }}" {{ old('discount_category_id') == $discount->id ? 'selected' : '' }}>{{ $discount->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="inventory_location" id="inventory_location" class="form-control" value="{{ old('inventory_location') }}">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="inventory_count" class="form-label">Inventory Count</label>
                                        <input type="number" name="inventory_count" id="inventory_count" class="form-control" value="{{ old('inventory_count') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="bom-container">
                                    <div class="row g-3 bom-row mb-3" data-index="0">
                                        <div class="col-md-3">
                                            <label for="bom[0][name]" class="form-label ">Name</label>
                                            <input type="text" name="bom[0][name]" id="bom_0_name" class="form-control @error('bom.0.name') is-invalid @enderror" value="{{ old('bom.0.name') }}" >
                                            @error('bom.0.name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @endif
                                        </div>
                                        <div class="col-md-2">
                                            <label for="bom[0][cost]" class="form-label ">Cost</label>
                                            <input type="number"  min="0" step="0.01" name="bom[0][cost]" id="bom_0_cost" class="form-control @error('bom.0.cost') is-invalid @enderror" value="{{ old('bom.0.cost') }}" >
                                            @error('bom.0.cost')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @endif
                                        </div>
                                        <div class="col-md-2">
                                            <label for="bom[0][tariff]" class="form-label">Tariff  (%)</label>
                                            <input type="number" min="0" step="0.01" name="bom[0][tariff]" id="bom_0_tariff" class="form-control @error('bom.0.tariff') is-invalid @enderror" value="{{ old('bom.0.tariff') }}">
                                            @error('bom.0.tariff')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @endif
                                        </div>
                                        <div class="col-md-2">
                                            <label for="bom[0][shipping]" class="form-label">Shipping</label>
                                            <input type="number" min="0" step="0.01" name="bom[0][shipping]" id="bom_0_shipping" class="form-control @error('bom.0.shipping') is-invalid @enderror" value="{{ old('bom.0.shipping') }}">
                                            @error('bom.0.shipping')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @endif
                                        </div>
                                        <div class="col-md-3">
                                            <label for="bom[0][vendor]" class="form-label">Manufacturer</label>
                                            <select name="bom[0][vendor]" id="bom_0_vendor" class="form-select">
                                                <option value="">-- None --</option>
                                                @foreach($vendors as $vendor)
                                                    <option value="{{ $vendor->name }}" {{ old('bom.0.vendor') == $vendor->name ? 'selected' : '' }}>
                                                        {{ $vendor->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-3">
                                            <label for="bom[0][hts]" class="form-label">HTS</label>
                                            <input type="text" name="bom[0][hts]" id="bom_0_hts" class="form-control" value="{{ old('bom.0.hts') }}">
                                        </div>

                                        <div class="col-md-3">
                                            <label for="bom[0][eccn]" class="form-label">ECCN</label>
                                            <input type="text" name="bom[0][eccn]" id="bom_0_eccn" class="form-control" value="{{ old('bom.0.eccn') }}">
                                        </div>
                                        <div class="col-md-3">
                                            <label for="bom[0][total]" class="form-label">Total</label>
                                            <input type="number" step="0.01" name="bom[0][total]" id="bom_0_total" class="form-control" value="{{ old('bom.0.total') }}" readonly>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">&nbsp;</label>
                                            <button type="button" class="btn btn-danger delete-bom-row" data-index="0">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.01" name="product_unit_cost" id="product_unit_cost" class="form-control" value="{{ old('product_unit_cost') }}">
                                </div>
                            </div>
                        </div>--}}
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <img id="previewImage" src="" alt="Product-image" style="width: 100%;height: auto;">
                        </div>
                    </div>
                </div>
...
@section('scripts')
    <script>
        ...
        const currentType = "{{ old('product_type') }}";
        let currentSubtype = "{{ old('product_sub_type') }}";
        const currentLinkedProductId = "{{ old('linked_product_id') }}";
                        ...
                        $.ajax({
                            ...
                            success: function (products) {
                                if (products.length > 0) {
                                    ...
                                    products.forEach(p => {
                                        const selected = parseInt(currentLinkedProductId) === parseInt(p.id) ? 'selected' : '';
...
// Add BOM row dynamically
            ...
            // Delete BOM row dynamically
            $bomContainer.on('click', '.delete-bom-row', function() {
                if ($('.bom-row').length > 1) { // Prevent deleting the last row
