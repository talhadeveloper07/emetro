    ...
    <div class="container-xl">
        ...
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                <div class="col">
                    <h2 class="page-title">
                        <a href="{{route('provisioning.index')}}"><svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-chevron-left"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M15 6l-6 6l6 6" /></svg></a>   Infinity 5XXX
                    </h2>
                </div>
                <!-- Page title actions -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="table-responsive">
                            <table class="table table-selectable card-table table-vcenter text-nowrap datatable" id="infinity5xxx_table">
                                <thead>
                                <tr>
                                    <th class="w-1">
...
$(function(){
    const table = $('#infinity5xxx_table').DataTable({
        ...
        lengthChange: false,  // removes "Show 10 entries"
        searching: false,
        info: false      // removes "Search" box
    });
